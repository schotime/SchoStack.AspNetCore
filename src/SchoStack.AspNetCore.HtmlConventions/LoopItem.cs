...
{
    public class LoopItem<TModel, T> where TModel : class
    {
        ...
        {
            public LoopInfo(Expression<Func<TModel, T>> currentExpression, IHtmlHelper<TModel> htmlHelper, int index, bool isFirst, bool isLast, bool isEven, bool isOdd)
            {
            ...
            public readonly IHtmlHelper<TModel> HtmlHelper;
        ...
        public LoopItem(Func<TModel, int, T> listFunc, IHtmlHelper<TModel> htmlHelper, T item, LoopInfo loopInfo)
        {
            Item = item;
            Info = loopInfo;
            _listFunc = listFunc;
